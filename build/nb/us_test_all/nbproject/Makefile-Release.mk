...
.build-conf: ${BUILD_SUBPROJECTS}
	"${MAKE}"  -f nbproject/Makefile-Release.mk dist/Release/GNU-MacOSX/us_test_all

dist/Release/GNU-MacOSX/us_test_all: ../microsupport/dist/Debug/GNU-MacOSX/libmicrosupport.a

dist/Release/GNU-MacOSX/us_test_all: ${OBJECTFILES}
...
${OBJECTDIR}/_ext/1014521522/us_test_all.o: ../../../tests/us_test_all.c 
	...
	${RM} $@.d
	$(COMPILE.c) -O2 -I../../../include -MMD -MP -MF $@.d -o ${OBJECTDIR}/_ext/1014521522/us_test_all.o ../../../tests/us_test_all.c
...
.clean-conf: ${CLEAN_SUBPROJECTS}
	${RM} -r build/Release
	${RM} dist/Release/GNU-MacOSX/us_test_all
