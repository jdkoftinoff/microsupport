...
.build-conf: ${BUILD_SUBPROJECTS}
	"${MAKE}"  -f nbproject/Makefile-Release.mk dist/Release/GNU-MacOSX/us_example_mudp_tx

dist/Release/GNU-MacOSX/us_example_mudp_tx: ../microsupport/dist/Debug/GNU-MacOSX/libmicrosupport.a

dist/Release/GNU-MacOSX/us_example_mudp_tx: ${OBJECTFILES}
...
${OBJECTDIR}/_ext/1285622248/us_example_mudp_tx.o: ../../../examples/us_example_mudp_tx.c 
	...
	${RM} $@.d
	$(COMPILE.c) -O2 -I../../../include -MMD -MP -MF $@.d -o ${OBJECTDIR}/_ext/1285622248/us_example_mudp_tx.o ../../../examples/us_example_mudp_tx.c
...
.clean-conf: ${CLEAN_SUBPROJECTS}
	${RM} -r build/Release
	${RM} dist/Release/GNU-MacOSX/us_example_mudp_tx
