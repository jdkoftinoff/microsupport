...
OUTPUT_PATH=${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/libmicrosupport.a
OUTPUT_BASENAME=libmicrosupport.a
PACKAGE_TOP_DIR=microsupport/
...
cd "${TOP}"
makeDirectory "${NBTMPDIR}/microsupport/lib"
