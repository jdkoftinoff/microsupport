...
AR=$(COMPILER_PREFIX)llvm-ar
RANLIB=$(COMPILER_PREFIX)llvm-ranlib
AS=$(COMPILER_PREFIX)llvm-as
LINK.cpp?=$(CXX)
LINK.c?=$(CC)
endif
...
ifndef DEP_GEN
DEP_GEN=$(1) -M -MT $(OUTPUT_OBJ_DIR)/$(2) -MF $(OUTPUT_OBJ_DIR)/$(3) $(4)
endif

FINAL_CXXFLAGS=$(LOCAL_PREPROCESS_FLAGS) $(SORTED_PREPROCESS_FLAGS) $(COMPILE_FLAGS) $(LOCAL_COMPILE_FLAGS) $(CXXFLAGS) 
FINAL_MMFLAGS=$(LOCAL_PREPROCESS_FLAGS) $(SORTED_PREPROCESS_FLAGS) $(COMPILE_FLAGS) $(LOCAL_COMPILE_FLAGS) $(CXXFLAGS) $(MMFLAGS) 
FINAL_CFLAGS=$(LOCAL_PREPROCESS_FLAGS) $(SORTED_PREPROCESS_FLAGS) $(COMPILE_FLAGS) $(LOCAL_COMPILE_FLAGS) $(CFLAGS) 
FINAL_MFLAGS=$(LOCAL_PREPROCESS_FLAGS) $(SORTED_PREPROCESS_FLAGS) $(COMPILE_FLAGS) $(LOCAL_COMPILE_FLAGS) $(CFLAGS) $(MFLAGS) 

FINAL_SHARED_CXXFLAGS=$(SHLIB_PREPROCESS_FLAGS) $(SHLIB_COMPILE_FLAGS) $(FINAL_CXXFLAGS)
FINAL_SHARED_MMFLAGS=$(SHLIB_PREPROCESS_FLAGS) $(SHLIB_COMPILE_FLAGS) $(FINAL_MMFLAGS)
FINAL_SHARED_CFLAGS=$(SHLIB_PREPROCESS_FLAGS) $(SHLIB_COMPILE_FLAGS) $(FINAL_CFLAGS)
FINAL_SHARED_MFLAGS=$(SHLIB_PREPROCESS_FLAGS) $(SHLIB_COMPILE_FLAGS) $(FINAL_MFLAGS)


ifeq ($(ENABLE_PRECOMPILED_HEADERS),1)

FINAL_CXXFLAGS_PRECOMPILE=$(PRECOMPILE_FLAGS) $(PRECOMPILE_HH_FLAGS) $(FINAL_CXXFLAGS) $(DEPENDENCY_OPTIONS)
FINAL_MMFLAGS_PRECOMPILE=$(PRECOMPILE_FLAGS) $(PRECOMPILE_HH_FLAGS) $(FINAL_MMFLAGS) $(DEPENDENCY_OPTIONS)
FINAL_CFLAGS_PRECOMPILE=$(PRECOMPILE_FLAGS) $(PRECOMPILE_H_FLAGS) $(FINAL_CFLAGS) $(DEPENDENCY_OPTIONS)
FINAL_MFLAGS_PRECOMPILE=$(PRECOMPILE_FLAGS) $(PRECOMPILE_H_FLAGS) $(FINAL_MFLAGS) $(DEPENDENCY_OPTIONS)

# For C++: (hh)
$(OUTPUT_OBJ_DIR)/%.hh.gch $(OUTPUT_OBJ_DIR)/%.hh.gch.d : %.hh
	@echo "PRECOMPILE HEADER $(PRECOMPILE_HH_FLAGS) : $(notdir $<)"
	$(call DEP_GEN,$(COMPILE.cpp) $(FINAL_CXXFLAGS_PRECOMPILE),$(@F),$*.d,$<) 
	@$(COMPILE.cpp) $(FINAL_CXXFLAGS_PRECOMPILE) -o $(OUTPUT_OBJ_DIR)/$(@F) $<
...
$(OUTPUT_OBJ_DIR)/%.h.gch $(OUTPUT_OBJ_DIR)/%.h.gch.d : %.h
	...
	$(call DEP_GEN,$(COMPILE.cpp) $(FINAL_CFLAGS_PRECOMPILE),$(@F),$*.d,$<) 
	@$(COMPILE.c) $(FINAL_CFLAGS_PRECOMPILE) -o $(OUTPUT_OBJ_DIR)/$(@F) $<
endif
...
$(OUTPUT_OBJ_DIR)/%.o $(OUTPUT_OBJ_DIR)/%.d : %.mm
	@echo "CXX mm : $(notdir $<)"
	$(call DEP_GEN,$(COMPILE.mm) $(FINAL_MMFLAGS),$(@F),$*.d,$<)
	@$(COMPILE.mm) -c $(FINAL_MMFLAGS) -o $(OUTPUT_OBJ_DIR)/$*.o $<

# For Objective C:
$(OUTPUT_OBJ_DIR)/%.o $(OUTPUT_OBJ_DIR)/%.d : %.m
	@echo "CC  m  : $(notdir $<)"
	$(call DEP_GEN,$(COMPILE.m) $(FINAL_MFLAGS),$(@F),$*.d,$<)
	@$(COMPILE.m) -c $(FINAL_MFLAGS) -o $(OUTPUT_OBJ_DIR)/$*.o $<

# For C++: (cpp)
$(OUTPUT_OBJ_DIR)/%.o $(OUTPUT_OBJ_DIR)/%.d : %.cpp
	@echo "CXX    : $(notdir $<)"
	$(call DEP_GEN,$(COMPILE.cpp) $(FINAL_CXXFLAGS),$(@F),$*.d,$<)
	@$(OMPILE.cc) $(FINAL_CXXFLAGS) -o $(OUTPUT_OBJ_DIR)/$*.o $<

# Asm For C++: (cpp)
$(OUTPUT_OBJ_DIR)/%.asm : %.cpp
	@echo "CXX asm  : $(notdir $<)"
	@$(COMPILE.cc) $(FINAL_CXXFLAGS) -S -o $(OUTPUT_OBJ_DIR)/$*.asm $<

# For C++: (cc)
$(OUTPUT_OBJ_DIR)/%.o $(OUTPUT_OBJ_DIR)/%.d : %.cc
	@echo "CXX    : $(notdir $<)"
	$(call DEP_GEN,$(COMPILE.cpp) $(FINAL_CXXFLAGS),$(@F),$*.d,$<)
	@$(COMPILE.cc) $(FINAL_CXXFLAGS) -o $(OUTPUT_OBJ_DIR)/$*.o $<
...
$(OUTPUT_OBJ_DIR)/%.o $(OUTPUT_OBJ_DIR)/%.d : %.c
	@echo "CC  c : $(notdir $<)"
	$(call DEP_GEN,$(COMPILE.c) $(FINAL_CFLAGS),$(@F),$*.d,$<)
	@$(COMPILE.c) $(FINAL_CFLAGS) -o $(OUTPUT_OBJ_DIR)/$*.o $<

# Asm For C:
$(OUTPUT_OBJ_DIR)/%.asm : %.c
	@echo "C asm  : $(notdir $<)"
	@$(COMPILE.c) $(FINAL_CFLAGS) -S -o $(OUTPUT_OBJ_DIR)/$*.asm $<
